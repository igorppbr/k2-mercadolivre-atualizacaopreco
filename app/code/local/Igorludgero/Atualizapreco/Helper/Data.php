    ...
    function updateBundlePriceMl($bundleId,$special_price){
        ...
        /*if($special_price==-1){
            if($_product->getSpecialPrice()>0) {
                Mage::log("chamou updateBundlePriceMl ao salvar simples, é -1", null, "il_atualizapreco.log");
            ...
            $model = Mage::getModel('catalog/product');
                    ...
                    if (count($idsOtherBundles) > 0) {
                        foreach ($idsOtherBundles as $idBundle) {
                            ...
                            $priceMl = $this->updateBundlePriceMl($idBundle,$_productBundle->getSpecialPrice());
